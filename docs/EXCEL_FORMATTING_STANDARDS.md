...
See `tracker_pnl/src/excel_exporter.py` for the canonical implementation.
...
| Pick Tracker    | `client/assets/misc_data/20251222_bombay711_tracker_consolidated.xlsx` | —                                       |
