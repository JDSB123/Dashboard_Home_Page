...
(function() {
    ...
    const TEAM_DATA_FALLBACK = {
        ...
        'connecticut': { abbr: 'CONN', fullName: 'UConn Huskies', league: 'ncaam', logoId: '41' },
        'u conn': { abbr: 'CONN', fullName: 'UConn Huskies', league: 'ncaam', logoId: '41' },
        'uconn': { abbr: 'CONN', fullName: 'UConn Huskies', league: 'ncaam', logoId: '41' },
        'uconn huskies': { abbr: 'CONN', fullName: 'UConn Huskies', league: 'ncaam', logoId: '41' },
        'abilene christian': { abbr: 'ACU', fullName: 'Abilene Christian Wildcats', league: 'ncaam', logoId: '2000' },
        'abilene christian wildcats': { abbr: 'ACU', fullName: 'Abilene Christian Wildcats', league: 'ncaam', logoId: '2000' },
        'arizona': { abbr: 'ARIZ', fullName: 'Arizona Wildcats', league: 'ncaam', logoId: '12' },
        'arizona wildcats': { abbr: 'ARIZ', fullName: 'Arizona Wildcats', league: 'ncaam', logoId: '12' },
        'montana st': { abbr: 'MTST', fullName: 'Montana State Bobcats', league: 'ncaam', logoId: '149' },
        'montana state': { abbr: 'MTST', fullName: 'Montana State Bobcats', league: 'ncaam', logoId: '149' },
        'montana state bobcats': { abbr: 'MTST', fullName: 'Montana State Bobcats', league: 'ncaam', logoId: '149' },
        'cal poly slo': { abbr: 'CPSU', fullName: 'Cal Poly Mustangs', league: 'ncaam', logoId: '13' },
        ...
        'oral roberts': { abbr: 'ORU', fullName: 'Oral Roberts Golden Eagles', league: 'ncaam', logoId: '198' },
        'oral roberts golden eagles': { abbr: 'ORU', fullName: 'Oral Roberts Golden Eagles', league: 'ncaam', logoId: '198' },
        'missouri st': { abbr: 'MOST', fullName: 'Missouri State Bears', league: 'ncaam', logoId: '2623' },
        'missouri state': { abbr: 'MOST', fullName: 'Missouri State Bears', league: 'ncaam', logoId: '2623' },
        'missouri state bears': { abbr: 'MOST', fullName: 'Missouri State Bears', league: 'ncaam', logoId: '2623' },
        'marist': { abbr: 'MAR', fullName: 'Marist Red Foxes', league: 'ncaam', logoId: '2368' },
        'marist red foxes': { abbr: 'MAR', fullName: 'Marist Red Foxes', league: 'ncaam', logoId: '2368' },
        'georgia tech': { abbr: 'GT', fullName: 'Georgia Tech Yellow Jackets', league: 'ncaam', logoId: '59' },
        'georgia tech yellow jackets': { abbr: 'GT', fullName: 'Georgia Tech Yellow Jackets', league: 'ncaam', logoId: '59' },
        'east tenn st': { abbr: 'ETSU', fullName: 'East Tennessee State Buccaneers', league: 'ncaam', logoId: '2193' },
        'east tennessee st': { abbr: 'ETSU', fullName: 'East Tennessee State Buccaneers', league: 'ncaam', logoId: '2193' },
        'east tennessee state': { abbr: 'ETSU', fullName: 'East Tennessee State Buccaneers', league: 'ncaam', logoId: '2193' },
        'east tennessee state buccaneers': { abbr: 'ETSU', fullName: 'East Tennessee State Buccaneers', league: 'ncaam', logoId: '2193' },
        'etsu buccaneers': { abbr: 'ETSU', fullName: 'East Tennessee State Buccaneers', league: 'ncaam', logoId: '2193' },
        'north carolina': { abbr: 'UNC', fullName: 'North Carolina Tar Heels', league: 'ncaam', logoId: '153' },
        ...
        'new england patriots': { abbr: 'NE', fullName: 'New England Patriots', league: 'nfl' },
        'patriots': { abbr: 'NE', fullName: 'New England Patriots', league: 'nfl' },
        'pats': { abbr: 'NE', fullName: 'New England Patriots', league: 'nfl' },
        'new england': { abbr: 'NE', fullName: 'New England Patriots', league: 'nfl' },
        'washington commanders': { abbr: 'WSH', fullName: 'Washington Commanders', league: 'nfl' },
        'commanders': { abbr: 'WSH', fullName: 'Washington Commanders', league: 'nfl' },
        'carolina panthers': { abbr: 'CAR', fullName: 'Carolina Panthers', league: 'nfl' },
        'panthers': { abbr: 'CAR', fullName: 'Carolina Panthers', league: 'nfl' },
        'carolina': { abbr: 'CAR', fullName: 'Carolina Panthers', league: 'nfl' },
        'atlanta falcons': { abbr: 'ATL', fullName: 'Atlanta Falcons', league: 'nfl' },
        'falcons': { abbr: 'ATL', fullName: 'Atlanta Falcons', league: 'nfl' },
        'new orleans saints': { abbr: 'NO', fullName: 'New Orleans Saints', league: 'nfl' },
        'saints': { abbr: 'NO', fullName: 'New Orleans Saints', league: 'nfl' },
        'new orleans': { abbr: 'NO', fullName: 'New Orleans Saints', league: 'nfl' },
        'chicago bears': { abbr: 'CHI', fullName: 'Chicago Bears', league: 'nfl' },
        'bears': { abbr: 'CHI', fullName: 'Chicago Bears', league: 'nfl' },
        'las vegas raiders': { abbr: 'LV', fullName: 'Las Vegas Raiders', league: 'nfl' },
