...
LEAGUE_PATTERNS = {
    'NFL': r'\b(chiefs|kc|bills|buf|ravens|bal|bengals|cin|cowboys|cows|dal|dallas|eagles|phi|49ers|niners|sf|lions|det|detroit|packers|pack|gb|vikings|vikes|minn|bears|chi|chicago|saints|no|nola|falcons|atl|atlanta|bucs|buccaneers|tb|panthers|car|seahawks|hawks|sea|rams|la|lar|cardinals|cards|ari|az|broncos|denver|den|chargers|bolts|lac|raiders|raider|lv|las|vegas|dolphins|fins|mia|jets|nyj|patriots|pats|ne|steelers|pit|browns|cle|texans|hou|colts|ind|jaguars|jags|jax|titans|ten|commanders|commies|commis|wash|was|wft|giants|nyg|new england|navy|bears|skins|nfl)\b',
    'NBA': r'\b(lakers|lal|celtics|celts|bos|boston|warriors|dubs|gs|gsw|bucks|mil|heat|mia|suns|phx|nuggets|nugs|den|denver|grizz|grizzlies|mem|kings|sac|cavs|cavaliers|cle|nets|bkn|knicks|nyk|sixers|76ers|phi|raptors|raps|tor|bulls|chi|chicago|hawks|atl|atlanta|hornets|cha|magic|orl|pistons|det|stones|pacers|ind|wizards|wiz|was|clippers|clips|lac|mavs|mavericks|dal|dallas|rockets|hou|spurs|sas|jazz|uta|blazers|por|wolves|timberwolves|min|minn|thunder|okc|pelicans|pels|nola|nop|phx|nyk|bkn|min|uta|sas|mil|chi|den|orl|ind|mia|cle|hou|atl|lak|toronto|milw|milwaukee|cleveland|wizz|nba)\b',
    'NCAAF': r'\b(cfp|cfb|college football|bowl|playoff|tulane|penn st|penn state|psu|wash st|washington st|wazzu|wsu|uf|florida|gators|gt|georgia tech|jmu|james madison|mich|michigan st|spartans|ohio|ohio st|osu|buckeyes|bama|alabama|georgia|uga|bulldogs|lsu|tigers|ole miss|rebels|auburn|tamu|texas am|aggies|oklahoma|ou|sooners|usc|trojans|ucla|bruins|oregon|ducks|utah|utes|colorado|buffs|arizona st|asu|sun devils|wash|washington|huskies|stanford|cardinal|cal|berkeley|bears|notre dame|nd|fighting irish|clemson|tigers|fsu|florida st|seminoles|miami|hurricanes|canes|nc state|ncsu|wolfpack|virginia|uva|cavaliers|pitt|panthers|louisville|cardinals|wake|forest|demon deacons|duke|blue devils|unc|north carolina|tar heels|syracuse|orange|bc|boston college|eagles|army|black knights|navy|midshipmen|byu|cougars|fresno|fresno st|bulldogs|boise|boise st|broncos|smu|mustangs|memphis|tigers|tulsa|golden hurricane|ucf|knights|usf|bulls|utsa|roadrunners|cincy|cincinnati|bearcats|wvu|west virginia|mountaineers|tcu|horned frogs|kansas st|ksu|wildcats|iowa st|isu|cyclones|ok st|oklahoma st|cowboys|texas tech|ttu|red raiders|tech|kk|kansas|jayhawks|miss st|mississippi st|southern miss|s miss|usm|fiu|florida international|nd state|ndsu|north dakota state|neb|nebraska|mizzou|missouri|east tenn|east tennessee|marshall|youngstown)\b',
    'NCAAM': r'\b(duke|blue devils|kentucky|ky|uk|wildcats|kansas|ku|jayhawks|unc|tar heels|zags|gonzaga|bulldogs|ucla|bruins|nova|villanova|wildcats|baylor|houston|cougars|purdue|boilermakers|tennessee|vols|volunteers|arizona|wildcats|uconn|huskies|arkansas|razorbacks|auburn|tigers|creighton|bluejays|marquette|golden eagles|xavier|x|musketeers|hoosiers|indiana|michigan|wolverines|msu|michigan st|spartans|ohio|ohio state|buckeyes|hawkeyes|iowa|illini|illinois|badgers|wisconsin|wiscy|wisky|terps|maryland|mary|scarlet knights|rutgers|nittany|penn state|psu|wildcats|northwestern|nw|gophers|minnesota|minn|huskers|nebraska|pilots|portland|lmu|loyola marymount|golden flashes|kent|kent state|mean green|north texas|jaguars|south alabama|cougars|washington state|wsu|trojans|usc|bulldogs|fresno|cougars|byu|black knights|army|tigers|clemson|rebels|ole miss|longhorns|texas|ducks|oregon|fighting irish|notre dame|hurricanes|miami|seminoles|fsu|florida state|cavaliers|virginia|wolfpack|nc state|orange|syracuse|panthers|pitt|cardinals|louisville|demon deacons|wake forest|yellow jackets|georgia tech|gt|eagles|boston college|bc|mustangs|smu|cardinal|stanford|cal|buffaloes|colorado|utes|utah|sun devils|arizona state|asu|monarchs|odu|old dominion|towson|tigers|seton|seton hall|ucsd|tritons|ucsb|gauchos|cs north|csn|northern colorado|umkc|kangaroos|pepperdine|waves|niagara|purple eagles|hawaii|warriors|rainbow warriors|duquesne|demons|so miss|southern miss|usm|charlotte|unc|chars|char|charleston|cougars|csu|rams|colorado state|butler|bulldogs|acu|abilene|christian|wildcats|wiz|wizards|sc|gamecocks|south carolina|pacific|tigers|vandy|vanderbilt|commodores|old dom|old dominion|ok|oklahoma|sooners|north dakota|fighting sioux|dakota|darty|dartmouth|big green|ncaam|cbb|sd st|san diego state|aztecs|depaul|blue demons|loyola|ramblers|chicago|marshall|thundering herd|youngstown|penguins|chatt|chattanooga|mocs|norfolk|lville|louisville|neb|nebraska|lak|lakeland|fresh|fresno st)\b',
}
...
def parse_pick_line(text: str, date: str) -> list:
    ...
    last_league: str | None = None  # Track league for context carry-over
    ...
    for line in lines:
        ...
        # If no league detected, try to use context from previous pick
        if league == 'UNKNOWN' and last_league:
            league = last_league
        ...
        if total_word_match or total_ou_match:
            ...
            last_league = league  # Carry forward league for context
            continue
