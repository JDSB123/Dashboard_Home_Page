...
module.exports = async function (context, req) {
    ...
    try {
        ...
        if (process.env.APPINSIGHTS_INSTRUMENTATIONKEY) {
            healthChecks.checks.monitoring = { status: 'healthy', message: 'Application Insights configured' };
        } else {
            healthChecks.checks.monitoring = { status: 'warning', message: 'Application Insights not configured' };
        }
