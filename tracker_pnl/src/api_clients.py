...
class SportsDataIOClient:
            ...
            for box in box_scores:
                ...
                for q in ["1", "2", "3", "4"]:
                    ...
                    if home_val is not None and away_val is not None:
                        quarter_scores[f"Q{q}"] = {"home": home_val, "away": away_val}
    ...
    def _parse_nfl_box_score_v3(self, data: Dict) -> Dict:
        ...
        return {"quarter_scores": quarter_scores, "half_scores": halves}
    ...
    def _parse_nfl_box_score(self, data: Dict) -> Dict:
        ...
        for q in ["1", "2", "3", "4"]:
            ...
            if home_key in data and away_key in data:
                quarters[f"Q{q}"] = {"home": data.get(home_key, 0), "away": data.get(away_key, 0)}
        ...
        return {"quarter_scores": quarters, "half_scores": halves}
...
class APIBasketballClient:
    ...
    def get_ncaam_games(self, game_date: str) -> List[Dict]:
        ...
        params = {
            "date": game_date,
            "league": "116",  # NCAA Division 1 league ID
            "season": self._get_season(game_date),
        }
    ...
    def _parse_nba_box_score(self, game: Dict) -> Dict:
        ...
        for q in ["1", "2", "3", "4"]:
            ...
            if home_score is not None and away_score is not None:
                quarters[f"Q{q}"] = {"home": home_score, "away": away_score}
